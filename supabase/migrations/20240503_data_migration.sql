...
-- 創建表達式索引
CREATE INDEX IF NOT EXISTS posts_created_month_idx ON public.posts(date_trunc('month', created_at));
CREATE INDEX IF NOT EXISTS events_date_month_idx ON public.events(date_trunc('month', date));
